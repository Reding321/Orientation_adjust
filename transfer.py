...
data_transforms = {
    'train_data_LGE': transforms.Compose([
        ...
        transforms.RandomResizedCrop((256, 256), scale=(0.9, 1), ratio=(0.9, 1.1)),
        transforms.ToTensor()
    ]),
...
pthfile = r"/home/hongtao2022/hongtao/Orientation_adjust_tool_Remake/Ori_C0.pth"
...
d2l.train_ch6(net, train_iter, test_iter, num_epochs, lr, d2l.try_gpu(2))
d2l.plt.show()

# torch.save(net.state_dict(), 'Ori_LGE.pth')
